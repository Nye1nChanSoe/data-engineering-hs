...
Run:
  ...
  python async_data_gen.py --bootstrap localhost:9092 --topic hsutest --rps 10
...
def to_avro_bytes(record: Dict[str, Any]) -> bytes:
    """Convert dict -> Avro binary using fastavro."""
    buf = io.BytesIO()
...
def main():
    ...
    ap.add_argument("--topic", default="hsutest", help="Kafka topic name")
